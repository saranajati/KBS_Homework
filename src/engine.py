...
class BridgePuzzleSolver(KnowledgeEngine):
    ...
    def record_new_state(
        self, state, left, right, flashlight_location, elapsed_time, path
    ):
    ...
    def duplicate_state_elimination(
        ...
        left1,
        right1,
        flashlight_location1,
        elapsed_time1,
        path1,
        depth1,
        left2,
        right2,
        flashlight_location2,
        elapsed_time2,
        path2,
        depth2,
    ):
            ...
            for i, sol in enumerate(self.solutions, 1):
                ...
                for j, move in enumerate(reversed(sol["moves"]), 1):
                    ...
                    if action == "cross":
                        ...
                        print(f"  Step {j}: {people[0]} returns → {time_taken} min")
        else:
